    ...
    <nav className='navbar'>
      ...
      <div id='options' className={` ${isActive ? "NotActive" : "active"}`}>
        <ul className={`options ${isActive ? "NotActive" : "active"}`}>
          ...
          <li className='items fadeUp' ><a className='link navl' rel="noreferrer" target="_blank" href="https://drive.google.com/file/d/1locj8KjcmZQY-_-0sPPKgXddaXG3QjMi/view?usp=sharing">Resume</a></li>
